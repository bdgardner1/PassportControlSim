...
passengers = []
gate_queue = [0,0,0,0,0,0]

num_iter = 1000
f = open('EnvTestv2.txt', newline='') 
...
for i in range(num_pass):
    passengers.append(Passenger_Model_v2.Passenger(environment, passengers, gate_queue))
